...
try {
  ...
  await pool.query(`
    ALTER TABLE orders
      ...
      ADD COLUMN IF NOT EXISTS sender_sender_address_line_1                varchar     NULL,
      ADD COLUMN IF NOT EXISTS sender_sender_address_line_2                varchar     NULL,
      ...
      ADD COLUMN IF NOT EXISTS recipient_recipient_address_line_1          varchar     NULL,
      ADD COLUMN IF NOT EXISTS recipient_recipient_address_line_2          varchar     NULL,
